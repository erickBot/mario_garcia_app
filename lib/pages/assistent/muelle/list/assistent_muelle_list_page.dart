...
import 'package:flutter_mario_garcia_app/pages/assistent/muelle/detail/assistent_muelle_detail_page.dart';
...
class AssistentMuelleListPage extends StatefulWidget {
  const AssistentMuelleListPage({super.key});

  @override
  State<AssistentMuelleListPage> createState() =>
      _AssistentMuelleListPageState();
}

class _AssistentMuelleListPageState extends State<AssistentMuelleListPage> {
        ...
        Navigator.push<void>(
          ...
          MaterialPageRoute<void>(
            builder: (BuildContext context) =>
                AssistentMuelleDetailPage(control: control),
          ),
        );
      },
      child: Container(
