...
class AssistentMuelleDetailPage extends StatefulWidget {
  final ControlPeso control;
  const AssistentMuelleDetailPage({super.key, required this.control});

  @override
  State<AssistentMuelleDetailPage> createState() =>
      _AssistentMuelleDetailPageState();
}

class _AssistentMuelleDetailPageState extends State<AssistentMuelleDetailPage> {
