...
class AdminDashboardMuelleDetailPage extends StatefulWidget {
  final ControlPeso control;
  const AdminDashboardMuelleDetailPage({super.key, required this.control});

  @override
  State<AdminDashboardMuelleDetailPage> createState() =>
      _AdminDashboardMuelleDetailPageState();
}

class _AdminDashboardMuelleDetailPageState
    extends State<AdminDashboardMuelleDetailPage> {
  UserModel? user;
  ControlPeso? control;
